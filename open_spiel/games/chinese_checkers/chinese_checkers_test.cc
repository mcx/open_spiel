...
void HopChainTest() {
  ...
  for (Action a : legal) {
    if (a == kPassAction) has_pass = true;
    else has_continuation = true;
  }
...
void WinConditionTest() {
  ...
  // 105 is at (12, 14), neighbor in direction 5 (DR: +1,+1) = (13, 15) = pos 114.
  ...
  // Cell 119 = (15,13). Neighbors: 116(14,12), 117(14,14), 118(15,11), -1, 120(16,12), -1.
